#!/usr/bin/env python3
"""
Aya-23-8B QLoRA fine-tuning for multilingual detoxification.

Uses the frozen v2_400plus grouped splits:
  train.csv, dev.csv, test.csv from results/training_v2_400plus/seed_2024/
...
OUTPUT_ROOT = Path("results/training_aya_23_8b")
MAX_LENGTH = 512
...
def main():
    ...
    print("Loading Aya-23-8B in 4-bit NF4...")
